...
typedef struct __mavlink_global_position_int_t
{
 ...
 uint16_t eph; ///< Error position horizontal
 uint16_t epv; ///< Error position vertical
 uint16_t hdg; ///< Compass heading in degrees * 100, 0.0..359.99 degrees. If unknown, set to: UINT16_MAX
} mavlink_global_position_int_t;

#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN 32
#define MAVLINK_MSG_ID_33_LEN 32

#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_CRC 79
...
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT { \
	...
	{  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_global_position_int_t, time_boot_ms) }, \
         ...
         { "eph", NULL, MAVLINK_TYPE_UINT16_T, 0, 26, offsetof(mavlink_global_position_int_t, eph) }, \
         { "epv", NULL, MAVLINK_TYPE_UINT16_T, 0, 28, offsetof(mavlink_global_position_int_t, epv) }, \
         { "hdg", NULL, MAVLINK_TYPE_UINT16_T, 0, 30, offsetof(mavlink_global_position_int_t, hdg) }, \
         } \
}
 ...
 * @param eph Error position horizontal
 * @param epv Error position vertical
...
static inline uint16_t mavlink_msg_global_position_int_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t time_boot_ms, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t eph, uint16_t epv, uint16_t hdg)
{
	...
	_mav_put_uint16_t(buf, 26, eph);
	_mav_put_uint16_t(buf, 28, epv);
...
static inline void mavlink_msg_global_position_int_send(mavlink_channel_t chan, uint32_t time_boot_ms, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t eph, uint16_t epv, uint16_t hdg)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN];
	_mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_global_position_int_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t eph, uint16_t epv, uint16_t hdg)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field eph from global_position_int message
 *
 * @return Error position horizontal
 */
static inline uint16_t mavlink_msg_global_position_int_get_eph(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint16_t(msg,  26);
}

/**
 * @brief Get field epv from global_position_int message
 *
 * @return Error position vertical
 */
static inline uint16_t mavlink_msg_global_position_int_get_epv(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_global_position_int_decode(const mavlink_message_t* msg, mavlink_global_position_int_t* global_position_int)
{
	...
	global_position_int->eph = mavlink_msg_global_position_int_get_eph(msg);
	global_position_int->epv = mavlink_msg_global_position_int_get_epv(msg);

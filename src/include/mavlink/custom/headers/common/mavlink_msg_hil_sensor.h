...
typedef struct __mavlink_hil_sensor_t
{
 ...
 float range_finder; ///< Range finder sensor distance readings in meters
...
#define MAVLINK_MSG_ID_HIL_SENSOR_LEN 68
#define MAVLINK_MSG_ID_107_LEN 68

#define MAVLINK_MSG_ID_HIL_SENSOR_CRC 101
#define MAVLINK_MSG_ID_107_CRC 101
...
#define MAVLINK_MESSAGE_INFO_HIL_SENSOR { \
	...
	{  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_sensor_t, time_usec) }, \
         ...
         { "range_finder", NULL, MAVLINK_TYPE_FLOAT, 0, 44, offsetof(mavlink_hil_sensor_t, range_finder) }, \
         { "abs_pressure", NULL, MAVLINK_TYPE_FLOAT, 0, 48, offsetof(mavlink_hil_sensor_t, abs_pressure) }, \
         { "diff_pressure", NULL, MAVLINK_TYPE_FLOAT, 0, 52, offsetof(mavlink_hil_sensor_t, diff_pressure) }, \
         { "pressure_alt", NULL, MAVLINK_TYPE_FLOAT, 0, 56, offsetof(mavlink_hil_sensor_t, pressure_alt) }, \
         { "temperature", NULL, MAVLINK_TYPE_FLOAT, 0, 60, offsetof(mavlink_hil_sensor_t, temperature) }, \
         { "fields_updated", NULL, MAVLINK_TYPE_UINT32_T, 0, 64, offsetof(mavlink_hil_sensor_t, fields_updated) }, \
         } \
}
 ...
 * @param range_finder Range finder sensor distance readings in meters
...
static inline uint16_t mavlink_msg_hil_sensor_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint64_t time_usec, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro, float xmag, float ymag, float zmag, float range_finder, float abs_pressure, float diff_pressure, float pressure_alt, float temperature, uint32_t fields_updated)
{
	...
	_mav_put_float(buf, 44, range_finder);
	_mav_put_float(buf, 48, abs_pressure);
	_mav_put_float(buf, 52, diff_pressure);
	_mav_put_float(buf, 56, pressure_alt);
	_mav_put_float(buf, 60, temperature);
	_mav_put_uint32_t(buf, 64, fields_updated);
	...
	packet.ymag = ymag;
	packet.zmag = zmag;
	packet.range_finder = range_finder;
...
{
	return mavlink_msg_hil_sensor_pack(system_id, component_id, msg, hil_sensor->time_usec, hil_sensor->xacc, hil_sensor->yacc, hil_sensor->zacc, hil_sensor->xgyro, hil_sensor->ygyro, hil_sensor->zgyro, hil_sensor->xmag, hil_sensor->ymag, hil_sensor->zmag, hil_sensor->range_finder, hil_sensor->abs_pressure, hil_sensor->diff_pressure, hil_sensor->pressure_alt, hil_sensor->temperature, hil_sensor->fields_updated);
}
...
{
	return mavlink_msg_hil_sensor_pack_chan(system_id, component_id, chan, msg, hil_sensor->time_usec, hil_sensor->xacc, hil_sensor->yacc, hil_sensor->zacc, hil_sensor->xgyro, hil_sensor->ygyro, hil_sensor->zgyro, hil_sensor->xmag, hil_sensor->ymag, hil_sensor->zmag, hil_sensor->range_finder, hil_sensor->abs_pressure, hil_sensor->diff_pressure, hil_sensor->pressure_alt, hil_sensor->temperature, hil_sensor->fields_updated);
}
...
static inline void mavlink_msg_hil_sensor_send(mavlink_channel_t chan, uint64_t time_usec, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro, float xmag, float ymag, float zmag, float range_finder, float abs_pressure, float diff_pressure, float pressure_alt, float temperature, uint32_t fields_updated)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_HIL_SENSOR_LEN];
	_mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_hil_sensor_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro, float xmag, float ymag, float zmag, float range_finder, float abs_pressure, float diff_pressure, float pressure_alt, float temperature, uint32_t fields_updated)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field range_finder from hil_sensor message
 *
 * @return Range finder sensor distance readings in meters
 */
static inline float mavlink_msg_hil_sensor_get_range_finder(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_hil_sensor_decode(const mavlink_message_t* msg, mavlink_hil_sensor_t* hil_sensor)
{
	...
	hil_sensor->range_finder = mavlink_msg_hil_sensor_get_range_finder(msg);
